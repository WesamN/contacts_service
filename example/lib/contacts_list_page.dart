  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(icon: Icon(Icons.create), onPressed: _openContactForm),
        ],
      ),
                    ...
                    return ListTile(
                      onTap: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder:
                                (BuildContext context) => ContactDetailsPage(
                                  c,
                                  onContactDeviceSave:
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed:
                () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => UpdateContactsPage(contact: _contact),
                  ),
                ),
          ),
          IconButton(
              ...
              Padding(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    ListTile(title: Text("City"), trailing: Text(a.city ?? "")),
                    ListTile(
                      title: Text("Region"),
          ...
          child: ListView(
            children: <Widget>[
              ...
              TextFormField(
                ...
                onSaved:
                    (v) => contact.phones = [Item(label: "mobile", value: v)],
                keyboardType: TextInputType.phone,
              ),
              TextFormField(
                decoration: const InputDecoration(labelText: 'E-mail'),
                onSaved:
                    (v) => contact.emails = [Item(label: "work", value: v)],
